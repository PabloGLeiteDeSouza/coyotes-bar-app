...
interface ICreateClientesProps {
  navigation: NativeStackNavigationProp<
    ...
    "atualizar-clientes"
  >;
  route: RouteProp<RootStackParamList, "atualizar-clientes">;
}
export const Update: React.FC<ICreateClientesProps> = ({
  navigation,
  route,
}) => {
  ...
  return (
    <ScrollView w="$full">
      <Box my="$5" w="$full" alignItems="center" gap="$5">
                  ...
                  >
                    ...
                    <Input>
                      <InputField
                        ...
                        placeholder="1234"
                        onChangeText={(text) =>
                          setFieldValue("numero", Number(text))
                        }
                      />
                    </Input>
              ...
              >
                ...
                <Input>
                  <InputField
                    ...
                    placeholder="100.00"
                    onChangeText={(text) =>
                      setFieldValue("limite", parseFloat(text))
                    }
                  />
                </Input>
